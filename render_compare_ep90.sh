...
GPU=${1:-5}
EPOCH=90
BASE_DIR="/data1/yangzhuowei/MambaTalk_new_512_proj_global_v1"
CKPT_DIR="${BASE_DIR}/outputs/audio2pose/custom/0315_043220_mambatalk_mhr_new"
DATA_DIR="${BASE_DIR}/data/smplxflame_30"
WAVE_DIR="${BASE_DIR}/data/wave16k"
OUT_DIR="${BASE_DIR}/outputs/render_test_ep${EPOCH}"
...
SAMPLES="X7Zb6vk3nok_0019_speaker2 y7XW4IZpnN0_0025_speaker1 epAwpBdUiYU_0007_speaker2"
...
if 'pred_cam_t' in d:
    for ax in range(3):
        d['pred_cam_t'][:, ax] = d['pred_cam_t'][:, ax].mean()
