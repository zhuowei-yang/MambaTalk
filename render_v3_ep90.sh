...
export TORCH_HOME=/data1/yangzhuowei/.cache/torch

GPU=${1:-3}
EPOCH=90
BASE_DIR="/data1/yangzhuowei/MambaTalk_new_512_proj_global_v3"
CKPT_DIR="${BASE_DIR}/outputs/audio2pose/custom/0317_135157_mambatalk_mhr_new"
DATA_DIR="${BASE_DIR}/data_new/smplxflame_30"
WAVE_DIR="${BASE_DIR}/data_new/wave16k"
OUT_DIR="${BASE_DIR}/outputs/render_v3_ep${EPOCH}"
...
SAMPLES="vaVOpQZi1WU_0021_speaker2 8i2gkAhvTvc_0033_speaker2 ImAp9mXuMg4_0020_speaker1"
