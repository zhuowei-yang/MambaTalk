...
GPU=${1:-4}
EPOCH=999
BASE_DIR="/data1/yangzhuowei/MambaTalk_new_512"
CKPT_DIR="${BASE_DIR}/outputs/audio2pose/custom/0312_111048_mambatalk"
DATA_DIR="${BASE_DIR}/data/smplxflame_30"
WAVE_DIR="${BASE_DIR}/data/wave16k"
OUT_DIR="${BASE_DIR}/outputs/render_test_preframes16"
...
SAMPLES="J_Pl9ftnNXE_0018_speaker1 hvNdco0wcPE_0017_speaker1 7Z1FtccUxl4_0052_speaker2"
