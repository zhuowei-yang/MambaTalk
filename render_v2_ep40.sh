...
GPU=${1:-1}
EPOCH=40
BASE_DIR="/data1/yangzhuowei/MambaTalk_new_512_proj_global_v2"
CKPT_DIR="${BASE_DIR}/outputs/audio2pose/custom/0317_054525_mambatalk_mhr_new"
DATA_DIR="${BASE_DIR}/data_new/smplxflame_30"
WAVE_DIR="${BASE_DIR}/data_new/wave16k"
OUT_DIR="${BASE_DIR}/outputs/render_v2_ep${EPOCH}"
...
SAMPLES="BYDLkW2UJjw_0009_speaker2 X7Zb6vk3nok_0019_speaker1 ucAAqShSYhM_0015_speaker1"
