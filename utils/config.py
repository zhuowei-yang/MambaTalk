...
def parse_args():
    ...
    parser.add("--res_scale", default=1.0, type=float)
    parser.add("--res_reg_weight", default=0.1, type=float)
    parser.add("--vae_latent_dim", default=256, type=int)
    parser.add("--res_pred_weight", default=1.0, type=float)
