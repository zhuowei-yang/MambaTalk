...
def parse_args():
    ...
    parser.add("--body_codebook_size", default=512, type=int)
    parser.add("--hand_codebook_size", default=256, type=int)
...
#    parser.add("--id_rep", default=None, type=str)
    ...
    parser.add("--face_dims", default=75, type=int)
    parser.add("--body_dims", default=130, type=int)
    parser.add("--hand_dims", default=108, type=int)
    parser.add("--global_dims", default=10, type=int)
...
#    parser.add("--gan_noise_size", default=0, type=int)
    ...
    # periodicity disentanglement (PD) — v8: FMLP-enhanced
    parser.add("--pd_n_channels", default=0, type=int)
    parser.add("--pd_checkpoint", default="", type=str)
    parser.add("--pd_n_filter_layers", default=2, type=int)
    parser.add("--lambda_p", default=0.1, type=float)
    parser.add("--lambda_motion", default=0.1, type=float)
    parser.add("--state_dir", default=None, type=str)
